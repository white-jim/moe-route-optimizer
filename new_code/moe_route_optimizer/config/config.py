...
class PathConfig:
    """路径配置"""
    # 项目根目录
    project_root: str = "/data/hdd1/expr_z/moe-proj/moe-route-optimizer"
...
class PerturbationConfig:
    ...
    num_perturb_tokens: int = 8
    
    # 扰动维度数量
    # num_perturb_dims: int = 50
    num_perturb_dims: int = 8
...
class ConvergenceConfig:
    ...
    latency_reduction_threshold: float = 0.10
    
    # 成功判定的精度保持阈值 (相对基线的比例)
    # accuracy_maintain_threshold: float = 1.0
    accuracy_maintain_threshold: float = 0.9
    ...
    reward_variance_threshold: float = 0.05
    
    # 成功收敛需要持续的episode数
    # success_patience: int = 3
    success_patience: int = 2
    
    # 精度持续下降的早停耐心值
    accuracy_early_stop_patience: int = 10
