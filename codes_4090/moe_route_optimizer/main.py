...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='logiqa', choices=['boolq', 'hellaswag', 'mmlu', 'arc', 'logiqa', 'gsm8k', 'lambada_openai', 'dummy'])
    parser.add_argument(
        '--dataset-path',
        type=str,
        default='../datasets/datasets/logiqa'
    )
