...
5. GSM8KEvaluator: GSM8K 数学问答评估器
6. DummyEvaluator: 虚拟评估器（用于测试）
"""
...
def create_evaluator(
    ...
    **kwargs
    ...
    Args:
        dataset_name: 数据集名称 ("boolq", "hellaswag", "mmlu", "arc", "gsm8k", "dummy")
        dataset_path: 数据集文件路径或 HuggingFace datasets 缓存目录
        split: 数据集划分 (train/validation/test)
        **kwargs: 传递给评估器的额外参数
    ...
    if dataset_name_lower == "boolq":
        ...
        raise ValueError(f"Unknown dataset: {dataset_name}. Supported: boolq, hellaswag, mmlu, arc, gsm8k, dummy.")
