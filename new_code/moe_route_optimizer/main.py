...
def main():
    ...
    parser.add_argument(
        ...
        default=os.path.join(_REPO_ROOT, 'models', 'DeepSeek-V2-Lite')
    )
    parser.add_argument('--dataset', type=str, default='boolq', choices=['boolq', 'hellaswag', 'mmlu', 'arc', 'gsm8k', 'dummy'])
    parser.add_argument(
        '--dataset-path',
        type=str,
        default='../datasets/datasets/boolq'
    )
