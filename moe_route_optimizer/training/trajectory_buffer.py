...
class RolloutBuffer:
    ...
    def __init__(self):
        ...
        self.perturb_types: List[torch.Tensor] = []
    ...
    def add(self, hidden_states: torch.Tensor,
        ...
        self.perturb_types.append(perturb_types.detach())
    ...
    def get_batch(self, device: str = 'cuda') -> Dict[str, torch.Tensor]:
        ...
        if len(self.hidden_states) == 1:
            return {
                ...
                'perturb_types': self.perturb_types[0].to(device),  # (batch, num_select)
        ...
        return {
            ...
            'perturb_types': torch.stack(self.perturb_types).to(device),
